...
def transcribe_audio():
    ...
    try:
        ...
        # DEBUG: Print path and file size
        print(f"[DEBUG] Converted audio path: {processed_audio_path}")
        print(f"[DEBUG] File size: {os.path.getsize(processed_audio_path)} bytes")
